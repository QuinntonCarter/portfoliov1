...
const colorsSelect = ['#ffa8cf', '#a6162b', '#00b9e3', '#006bd6', '#ffaa00', '#ff3c19']
...
for(let i = 0; i < particleCount; i++){
    ...
    particlePositions[i3 + 1] = objectsDistance * 0.4 - Math.random() * objectsDistance;
...
const tick = () => {
    ...
    particleGroup.position.x += (parallaxX - particleGroup.position.x) * .05 * deltaTime
    particleGroup.position.y += (parallaxY - particleGroup.position.y) * .05 * deltaTime
